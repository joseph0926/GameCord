    ...
    <div className="bg-black">
      ...
      <section className="details">
        <div className="inspection layout-ws" ref={inspectionRef}>
          ...
          <p>
            My Note's comprehensive approach ensures every aspect of your notes
            and schedules are seamlessly synchronized, offering an efficient and
        ...
        <section className="slider" ref={sliderRef}>
          <div className="slide">
            <div className="inner layout-ws">
              <p className="slide-p">
                My Note는 사용자의 일정 관리와 메모 작성을 더욱 쉽고 효율적으로
                만들어줍니다. 간편하게 메모를 추가하고, 일정을 확인할 수
                있습니다.
              </p>
            </div>
          </div>
          <div className="slide">
            <div className="inner layout-ws">
              <p className="slide-p">
                AI 챗 기능을 통해 일정 상담이 가능합니다. My Note의 AI는
                사용자의 요구사항을 정확히 이해하고, 필요한 조언을 제공합니다.
              </p>
            </div>
          </div>
          <div className="slide">
            <div className="inner layout-ws">
              <p className="slide-p">
                효과적인 스케쥴 관리로, 하루를 더욱 생산적으로 만들어보세요. My
                Note와 함께라면 가능합니다.
              </p>
            </div>
          </div>
        ...
        <div className="inner-contact">
          ...
          <div className="layout-ws">
            ...
            <p className="contact-desc">
              My Note의 최신 기능에 대한 높은 관심으로 인해, 우리는 독점적인
              대기 목록을 시작했습니다. 이를 통해 고객님께서는 새로운 기능을
              가장 먼저 경험하실 수 있습니다.
            </p>
          </div>
