  ...
  return (
    <div>
      <ActionTooltip side="right" align="center" label="Home">
        <button className="group flex items-center" onClick={() => router.push('/')}>
          <div className="mx-3 flex h-[48px] w-[48px] items-center justify-center overflow-hidden rounded-[24px] bg-background transition-all group-hover:rounded-[16px] group-hover:bg-primary-500 dark:bg-neutral-700">
